...
public class CategoryPvUvFiller implements FieldFiller {

	// private static final Log LOG =
	// LogFactory.getLogger(CategoryPvUvFiller.class);

	private CategoryDao dao;

	public CategoryPvUvFiller(CategoryDao dao) {
		this.dao = dao;
	}
