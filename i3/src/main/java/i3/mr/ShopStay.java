...
public class ShopStay extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(getConf(), date + "ShopStay");
		job.setJarByClass(ShopStay.class);
		...
		FileOutputFormat.setOutputPath(job, new Path(args[0] + "_shop_stay"));
	...
	public static void main(String[] args) throws Exception {
		System.out.println("ShopStay Start...");
		System.exit(ToolRunner.run(new Configuration(), new ShopStay(), args));
	}
