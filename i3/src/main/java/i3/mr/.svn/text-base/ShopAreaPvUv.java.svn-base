...
public class ShopAreaPvUv extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(getConf(), date + "ShopAreaPvUv");
		job.setJarByClass(ShopAreaPvUv.class);
	...
	public static void main(String[] args) throws Exception {
		System.out.println("ShopAreaPvUv Start...");
		System.exit(ToolRunner.run(new Configuration(), new ShopAreaPvUv(),
				args));
	}
