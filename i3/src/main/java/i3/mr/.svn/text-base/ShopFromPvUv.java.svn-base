...
public class ShopFromPvUv extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(getConf(), date + "ShopFromPvUv");
		job.setJarByClass(ShopFromPvUv.class);
	...
	public static void main(String[] args) throws Exception {
		System.out.println("ShopFromPvUv Start...");
		System.exit(ToolRunner.run(new Configuration(), new ShopFromPvUv(),
				args));
	}
