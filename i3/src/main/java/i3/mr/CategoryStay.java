...
public class CategoryStay extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(getConf(), date + "CategoryStay");
		job.setJarByClass(CategoryStay.class);
		...
		FileOutputFormat.setOutputPath(job,
				new Path(args[0] + "_category_stay"));
	...
	public static void main(String[] args) throws Exception {
		System.out.println("CategoryStay Start...");
		System.exit(ToolRunner.run(new Configuration(), new CategoryStay(),
				args));
	}
