...
public class IndexAreaPvUv extends Configured implements Tool {
	...
	public static class M extends Mapper<LongWritable, Text, Text, Text> {
		...
		protected void map(LongWritable key, Text value, Context context)
			...
			String[] tmp = new String[] { nick, province, ip, "" + hour,
					"" + minute, "" + second };
	...
	public static class R extends Reducer<Text, Text, Text, Text> {
		...
		protected void reduce(Text key, Iterable<Text> values, Context context)
			...
			context.write(new Text(shop + " " + province), new Text(pv + " "
					+ uv));
		}
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(getConf(), date + "IndexAreaShopPvUv");
		job.setJarByClass(IndexAreaPvUv.class);
	...
	public static void main(String[] args) throws Exception {
		System.out.println("IndexAreaShopPvUv Start...");
		System.exit(ToolRunner.run(new Configuration(),
				new IndexAreaPvUv(), args));
	}
