...
public class AllTrades2 {

	private static final Logger LOG = LoggerFactory.getLogger(AllTrades2.class);
		...
		try {
			...
			for (Element trade : trades) {
				...
				if (status.equals("WAIT_BUYER_PAY")
						|| status.equals("WAIT_SELLER_SEND_GOODS")
